...
map.on('draw:created', function (e) {
	...
	if (type === 'rectangle') {
		...
		then(function(d){var result = d.map(function(a) {return a.properties;});
			results = result;	// Trip Info: avspeed, distance, duration, endtime, maxspeed, minspeed, starttime, streetnames, taxiid, tripid
			++ind;
			DrawRS(result);
		});
	}
	...
	var scope = angular.element($("#navButtons")).scope();
